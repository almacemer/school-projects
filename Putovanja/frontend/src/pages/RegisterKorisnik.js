...
function RegisterKorisnik() {
    ...
    function registerUser() {
        axios.post('http://127.0.0.1:8000/api/korisnik/', {
    ...
    <div className='pozadina' data-theme={tema}>
        ...
        <div className="login">
            <div className='container'>
                ...
                <input type="text" id="firstname" placeholder="Unesite ime" value={firstname} onChange={e => setFirstname(e.target.value)}/>
                <br></br>
                
                <label htmlFor="lastname">Prezime</label> <br></br>
                <input type="text" id="Lastname" placeholder="Unesite prezime" value={lastname} onChange={e => setLastname(e.target.value)}/>
                <br></br>
